    ...
    #define NXPBUILD__PHHAL_HW_PN7462AU                   /**< NFC Controller PN7462AU HAL */
        ...
        #define NXPBUILD__PHHAL_HW_PN7642                 /**< NFC Controller PN7642 HAL */
            ...
            #define NXPBUILD__PHHAL_HW_SAMAV3             /**< SAMAV3 HAL Component is included */
                ...
                #undef NXPRDLIB_REM_GEN_INTFS             /**< Disable Generic interfaces when SAMAV3 HAL Component is enabled */
...
//        #define NXPBUILD__PHAC_DISCLOOP_TYPEA_JEWEL_TAGS    /**< SRC/DATA to Detect cards such as NFC Forum T1T, Topaz/Jewel is included. */
        ...
        #define NXPBUILD__PHPAL_I14443P3A_SW_ECP
        #ifdef NXPBUILD__PHPAL_I14443P3A_SW_ECP
            #define NXPBUILD__PHAC_DISCLOOP_SW_ECP	    /**< Detect Passive VAS TypeA Tags/Peers */
        #endif
    #endif
    ...
    #ifndef NXPBUILD__PHHAL_HW_PN5190
...
//#define NXPBUILD__PH_CIDMANAGER_SW                            /**< CID Manager SW Component is included. */
...
#ifdef NXPBUILD__PHHAL_HW_SAMAV3                            /**< SAM AV3 Component */
    #define NXPBUILD__PHBAL_REG_SAM                         /**< SAM Bal Component is included */

    #define NXPBUILD__PH_KEYSTORE_SAMAV3                    /**< SAMAV3 KeyStore Component is included. */

    #define NXPBUILD__PHAL_VCA_SAM_NONX                     /**< VCA SAM NONX Component is included */
    #ifdef NXPBUILD__PHAL_VCA_SAM_NONX
        #define NXPBUILD__PHAL_VCA_SAMAV3_NONX              /**< VCA SAM AV3 NONX Component is included */
    #endif /* NXPBUILD__PHAL_VCA_SAM_NONX */

    #define NXPBUILD__PHAL_MFDFEVX_SAM_NONX                 /**< MFDFEVX SAM NONX Component is included */
#endif /* NXPBUILD__PHHAL_HW_SAMAV3 */
   ...
   #define NXPBUILD__PH_KEYSTORE_SW                         /**< SW KeyStore Component is included. */
       ...
       #define NXPBUILD__PH_KEYSTORE_SW                     /**< SW KeyStore Component is included. */
    #endif /* NXPBUILD__PHHAL_HW_SAMAV3 */
    #ifndef NXPBUILD__PHHAL_HW_SAMAV3
    ...
    #define NXPBUILD__PH_CRYPTORNG_SW                       /**< Crypto RNG Software Component is included. */
...
//        #define NXPBUILD__PH_NDA_MFDF                           /**< Mifare DESFire implementation under NDA */
    ...
    #if defined(NXPBUILD__PH_TMIUTILS) || defined(NXPBUILD__PHAL_VCA_SW)|| defined(NXPBUILD__PHAL_VCA_SAM_NONX)
        #ifndef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
            #define NXPBUILD__PHAL_MFDFEVX_SW                   /**< AL MIFARE DESFire EV2 contactless IC SW Component is included */
        #endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
        #define NXPBUILD__PHAL_MFDFEVX_NDA                      /**< MIFARE DESFire EVx contactless IC build macro for IP Protection */
...
//        #define NXPBUILD__PHAL_MFPEVX_SW                        /**< AL MIFARE Plus EV1 contactless IC SW Component is included */

        #if defined(NXPBUILD__PH_CRYPTOSYM_SW) || defined(NXPBUILD__PH_CRYPTORNG_SW)
//            #define NXPBUILD__PH_NDA_MFP                        /**< Mifare Plus implementation under NDA */
//            #define NXPBUILD__PHAL_MFPEVX_NDA                   /**< MIFARE Plus EVx contactless IC implementation under NDA */
        #endif
    #endif
