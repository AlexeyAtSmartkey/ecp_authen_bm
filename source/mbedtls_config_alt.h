/**
 * \file mbedtls_config_alt.h
 *
 * \brief Custom Configuration options (set of defines)
 *
 *  This set of compile-time options may be used to enable
 *  or disable features selectively, and reduce the global
 *  memory footprint.
 *
 *  \note The file structure is maintained similar to actual mbedtls_config.h.
 *        Only difference will be commenting / un-commenting the macros that are required.
 */
/*
