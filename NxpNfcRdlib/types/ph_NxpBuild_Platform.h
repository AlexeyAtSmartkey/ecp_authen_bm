...
/*********************************************************************************************************************************************************************************/
    ...
    #define NXPBUILD__PHAL_ICODE_SAM_NONX                       /**< AL ICODE SAM NONX Component is included */

    #define NXPBUILD__PHAL_VCA_SAM_NONX                         /**< AL VCA SAM NONX Component is included */
    #ifdef NXPBUILD__PHAL_VCA_SAM_NONX
        #define NXPBUILD__PHAL_VCA_SAMAV3_NONX                  /**< AL VCA SAM AV3 NONX Component is included */
    #endif /* NXPBUILD__PHAL_VCA_SAM_NONX */

    #define NXPBUILD__PHAL_MFDFEVX_SAM_NONX                     /**< AL MFDFEVX SAM NONX Component is included */

    #define NXPBUILD__PHAL_MFPEVX_SAM_NONX                      /**< AL MFPEVX SAM NONX Component is included */

    #define NXPBUILD__PHAL_MFUL_SAM_NONX                        /**< AL MFUL SAM NONX Component is included */
    #ifdef NXPBUILD__PHAL_MFUL_SAM_NONX
        #define NXPBUILD__PHAL_MFUL_SAMAV3_NONX                 /**< AL MFUL SAM AV3 NONX Component is included */
...
/*********************************************************************************************************************************************************************************/
...
#ifndef NXPBUILD__PHAL_MFUL_SAM_NONX
    ...
    #define NXPBUILD__PHAL_MFDF_SW                              /**< AL MIFARE DESFire contactless IC SW Component is included */
        ...
        #ifndef NXPBUILD__PHAL_MFPEVX_SAM_NONX
...
#ifdef NXPBUILD__PHPAL_SLI15693_SW
#ifndef NXPBUILD__PHAL_ICODE_SAM_NONX
