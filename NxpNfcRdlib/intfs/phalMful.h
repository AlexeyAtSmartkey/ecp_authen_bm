...
/** \defgroup phalMful_Sam_NonX Component : Sam_NonX
 * @{
 */


#ifdef NXPBUILD__PHAL_MFUL_SAMAV3_NONX
#define PHAL_MFUL_SAMAV3_NONX_ID                            0x04    /**< ID for SamAV3 NonX MIFARE Ultralight layer. */

/** \brief Private parameter structure for Mifare Ultralight Sam AV3 component */
typedef struct
{
    uint16_t wId;                                                   /**< Layer ID for this component, NEVER MODIFY! */
    phhalHw_SamAV3_DataParams_t * pHalSamDataParams;                /**< Pointer to halHw_SamAV3 parameter structure. */
    void * pPalMifareDataParams;                                    /**< Pointer to palMifare parameter structure. */
    uint8_t bCMACReq;                                               /**< Get/Set Config to include CMAC for required Commands */
    uint16_t wCmdCtr;                                               /**< Command count within transaction. */
    uint8_t bAuthMode;                                              /**< Authentication PWD [0x1B] or AES [0x1A] */
    uint8_t bAdditionalInfo;                                        /**< Specific error codes for MFUL generic errors or To get the response length of some commands. */
    uint8_t bRamKeyNo;                                              /**< RAM KEY Number*/
    uint8_t bRamKeyVer;                                             /**< RAM KEY Version*/
} phalMful_SamAV3_NonX_DataParams_t;
 ...
 * \retval #PH_ERR_SUCCESS Operation successful.
 */
phStatus_t phalMful_SamAV3_NonX_Init(
        phalMful_SamAV3_NonX_DataParams_t * pDataParams,            /**< [In] Pointer to this layer's parameter structure. */
        uint16_t wSizeOfDataParams,                                 /**< [In] Specifies the size of the data parameter structure. */
        phhalHw_SamAV3_DataParams_t * pHalSamDataParams,            /**< [In] Pointer to halHw_SamAV3 parameter structure. */
        void * pPalMifareDataParams                                 /**< [In] Pointer to palMifare parameter structure. */
    );
#endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */

/**
 * end of phalMful_Sam_NonX
 * @}
 */
