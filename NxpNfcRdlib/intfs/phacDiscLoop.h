 ...
 * - VAS Type A (Proprietary)
 * */
#define PHAC_DISCLOOP_PASS_POLL_MAX_TECHS_SUPPORTED           0x07U
...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
/**
* \name VAS default parameters.
*/
/*@{*/
#define PHAC_DISCLOOP_VAS_MAX_ATQA_LENGTH                     0x02U   /**< Answer to VASUP-A (ATVA) length for VAS card type. */
/*@}*/
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
    PHAC_DISCLOOP_TECH_TYPE_VAS,                                      /**< VAS Type A bit position. */
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
...
typedef struct
{
    uint8_t bTotalTagsFound;                                          /**< Number of VAS tags found. */
    uint8_t bFormatByte;                                              /**< Format Byte of VAS Command. */
    uint8_t * pCmdBytes;                                              /**< Pointer to remaining of the VAS Command bytes. */
    uint8_t bLenCmdBytes;                                             /**< Number of VAS Command bytes excluding VASUP-A header and Format Byte. */
    uint8_t aAtva[PHAC_DISCLOOP_VAS_MAX_ATQA_LENGTH];                 /**< ATVA received from VAS compliant device. */
} phacDiscLoop_Sw_VAS_Info_t;
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
...
typedef struct
{
     ...
     * #PHAC_DISCLOOP_POS_BIT_MASK_VAS       -> Detect VAS Type A. \n
     *
     * Use \ref phacDiscLoop_SetConfig with #PHAC_DISCLOOP_CONFIG_PAS_POLL_TECH_CFG
     ...
     * #PHAC_DISCLOOP_CONFIG_GTVAS_VALUE_US       -> Guard time for VAS Type A.\n
     *
...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
    /**
     * Information gathered from VAS devices/tags in poll mode.
     *
     * Application can access this directly to get information like UID, UID size,
     * SAK etc. of all VAS devices/tags detected in poll mode.
     * */
    phacDiscLoop_Sw_VAS_Info_t sVASTargetInfo;
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
/**
 * Set/Get the guard time for VAS Type A technology in microseconds for passive poll
 * mode.
 *
 * Default guard time is set to 500 microseconds for VAS Type A.
 * */
#define PHAC_DISCLOOP_CONFIG_GTVAS_VALUE_US                   0x07U
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
/**
 * Sets the VASUP-A command Format Byte parameter.
 *
 * Default is 0x01.
 * */
#define PHAC_DISCLOOP_CONFIG_VASUP_A_FORAMT_BYTE              0x72U
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
