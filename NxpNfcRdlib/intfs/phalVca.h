...
/**
 * \defgroup phalVca_Sam_NonX Component : Sam_NonX
 * @{
 */

#ifdef NXPBUILD__PHAL_VCA_SAMAV3_NONX

#define PHAL_VCA_SAMAV3_NONX_ID                                     0x05U   /**< ID for SamAV3_NonX Virtual Card Architecture layer. */

/** \brief SAM AV3 NonX AL-VCA parameter structure. */
typedef struct
{
    uint16_t wId;                                                           /**< Layer ID for this component, NEVER MODIFY! */
    void * pPalMifareDataParams;                                            /**< Pointer to the parameter structure of the palMifare layer. */
    phhalHw_SamAV3_DataParams_t * pSamHal;                                  /**< Pointer to the parameter structure of the Sam Av3 HAL. */
    uint8_t bWrappedMode;                                                   /**< Wrapped APDU mode. All native commands need to be sent wrapped in ISO 7816 APDUs. */
    uint8_t bExtendedLenApdu;                                               /**< Extended length APDU. If set the native commands should be wrapped in extended format */
    uint8_t bOption;                                                        /**< bOption parameter for Timing measurements ON/OFF. */
    uint16_t wAdditionalInfo;                                               /**< Specific error codes for VC generic errors. */
} phalVca_SamAV3_NonX_DataParams_t;
 ...
 * \retval #PH_ERR_SUCCESS Operation successful.
 */
phStatus_t phalVca_SamAV3_NonX_Init(
        phalVca_SamAV3_NonX_DataParams_t * pDataParams,                     /**< [In] Pointer to this layer's parameter structure. */
        uint16_t wSizeOfDataParams,                                         /**< [In] Specifies the size of the data parameter structure. */
        phhalHw_SamAV3_DataParams_t * pSamHal,                              /**< [In] Pointer to the parameter structure of the Sam HAL.  */
        void * pPalMifareDataParams                                         /**< [In] Pointer to the parameter structure of the palMifare layer. */
    );
#endif /* NXPBUILD__PHAL_VCA_SAMAV3_NONX */

/**
 * end of group phalVca_Sam_NonX
 * @}
 */
