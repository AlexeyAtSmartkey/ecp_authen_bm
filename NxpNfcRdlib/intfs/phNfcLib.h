 ...
 * @name HAL type
 *
 * \anchor nfc_lib_definitions_Hal_type
 * \brief Option to get the addresses of various Hal components. These options should be used for
 * \ref phNfcLib_GetDataParams_Extended "Extended GetDataParams" API.
 * \{
 */
#define PH_NFCLIB_COMP_PHHAL_HW_SAMAV3        0x04U /**< Option to get the address of Hal component initialized for SAM AV3 */
 ...
 * @name KeyStore type
 *
 * \anchor nfc_lib_definitions_KeyStore_type
 * \brief Option to get the addresses of various KeyStore components. These options should be used for
 * \ref phNfcLib_GetDataParams_Extended "Extended GetDataParams" API.
 * \{
 */
#define PH_NFCLIB_COMP_KEYSTORE_SAMAV3        0x05U /**< Option to get the address of KeyStore component initialized for SAM AV3 */
 ...
 * @name ICode type
 *
 * \anchor nfc_lib_definitions_ICode_type
 * \brief Option to get the addresses of various ICode components. These options should be used for
 * \ref phNfcLib_GetDataParams_Extended "Extended GetDataParams" API.
 * \{
 */
#define PH_NFCLIB_COMP_ICODE_SAM_NONX         0x06U /**< Option to get the address of ICode component initialized for SAM AV3 */

/**
 * @name Mifare Desfire EVx type
 *
 * \anchor nfc_lib_definitions_Mifare Desfire EVx_type
 * \brief Option to get the addresses of various Mifare Desfire EVx components. These options should be used for
 * \ref phNfcLib_GetDataParams_Extended "Extended GetDataParams" API.
 * \{
 */
#define PH_NFCLIB_COMP_MFDFEVX_SAM_NONX       0x07U /**< Option to get the address of Mifare Desfire EVx component initialized for SAM AV3 */

/**
 * @name Mifare plus EVx type
 *
 * \anchor nfc_lib_definitions_Mifare plus EVx_type
 * \brief Option to get the addresses of various Mifare plus EVx components. These options should be used for
 * \ref phNfcLib_GetDataParams_Extended "Extended GetDataParams" API.
 * \{
 */
#define PH_NFCLIB_COMP_MFPEVX_SAM_NONX        0x08U /**< Option to get the address of Mifare plus EVx component initialized for SAM AV3 */

/**
 * @name Mifare Ultralight type
 *
 * \anchor nfc_lib_definitions_Mifare Ultralight_type
 * \brief Option to get the addresses of various Mifare Ultralight components. These options should be used for
 * \ref phNfcLib_GetDataParams_Extended "Extended GetDataParams" API.
 * \{
 */
#define PH_NFCLIB_COMP_MFUL_SAM_NONX          0x09U /**< Option to get the address of Mifare Ultralight component initialized for SAM AV3 */
...
/**
 * \anchor activation_vas
 * This configuration parameter is used to either enable/disable vas polling.
 * Depending on this either vas polling is done based on the chosen profile using \ref activation_profile.
 *
 * \par Parameter Size
 * 1 Byte (uint8_t)
 * \par Allowed Values
 * \li \p #PH_OFF VAS polling is OFF.
 * \li \p #PH_ON  VAS polling is ON.
 * \par Default Value
 * \p #PH_OFF
 */
#define PH_NFCLIB_CONFIG_ACTIVATION_VAS_POLLING          0x5U
