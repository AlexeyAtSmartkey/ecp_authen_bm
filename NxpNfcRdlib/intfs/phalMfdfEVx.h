...
/**
 * \defgroup phalMfdfEVx_Sam_NonX Component : Sam_NonX
 * @{
 */

#define PHAL_MFDFEVX_SAMAV3_NONX_ID                                     0x02U   /**< ID for SamAV3 Non X MF DesFire EVx layer. */
#define PHAL_MFDFEVX_BLOCK_SIZE                                         16U     /**< Block Size */

/** \brief MIFARE DESFire EVx SAM NonX parameter structure  */
typedef struct
{
    uint16_t wId;                                                               /**< Layer ID for this component, NEVER MODIFY! */
    ...
    uint8_t * pTmpBuffer;                                                       /**< Temporary buffer for framing the command buffer. */
    uint16_t wTmpBufSize;                                                       /**< Size of Temporary buffer. */
    ...
    uint8_t bCmdCode;                                                           /**< Command code. This will be used for differentiating the comman error codes between different commands. */
    uint8_t bUid[15];                                                           /**< Complete UID of the PICC. This will be updated when \ref phalMfdfEVx_GetCardUID interface is called. */
    uint8_t bUidLength;                                                         /**< Length of bytes available in bUid buffer. */
    uint8_t bReturn_FabID;                                                      /**< Get / Set the return of Fabrication Identifier. When Set will be utilized during GetVersion command exchange. */
} phalMfdfEVx_SamAV3_NonX_DataParams_t;

/**
 * \brief Initializes the Desfire EVx Sam AV3 component in Non X mode (S mode).
 *
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 ...
 */
phStatus_t phalMfdfEVx_SamAV3_NonX_Init(
        phalMfdfEVx_SamAV3_NonX_DataParams_t * pDataParams,                     /**< [In] Pointer to this layer's parameter structure. */
        uint16_t wSizeOfDataParams,                                             /**< [In] Specifies the size of the data parameter structure */
        ...
        uint8_t * pTmpBuffer,                                                   /**< [In] Temporary buffer for framing the command buffer. Should be higher than 256 bytes. */
        uint16_t wTmpBufSize                                                    /**< [In] Size of Temporary buffer. */
    );

/**
 * end of group phalMfdfEVx_Sam_NonX
 * @}
 */
 ...
 */
phStatus_t phalMfdfEVx_Authenticate(
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_AuthenticateISO(
        void *pDataParams,                                                      /**< [In] Pointer to this layer's parameter structure. */
        uint16_t wOption,                                                       /**< [In] One of the below options.
                                                                                 *          \arg #PHAL_MFDFEVX_NO_DIVERSIFICATION
                                                                                 *          \arg #PHAL_MFDFEVX_DIV_METHOD_ENCR
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_AuthenticateAES(
        void *pDataParams,                                                      /**< [In] Pointer to this layer's parameter structure. */
        uint16_t wOption,                                                       /**< [In] One of the below options.
                                                                                 *          \arg #PHAL_MFDFEVX_NO_DIVERSIFICATION
                                                                                 *          \arg #PHAL_MFDFEVX_DIV_METHOD_ENCR
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_AuthenticateEv2(
        void *pDataParams,                                                      /**< [In] Pointer to this layer's parameter structure. */
...
/**
 * end of group phalMfdfEVx_SecureMessaging
 * @}
 */
...
#define PHAL_MFDFEVX_SET_CONFIG_OPTION5                                 0x05U   /**< Option 5 for updating the Capibility Data. */
...
/**
 * \brief Configures the card and pre personalizes the card with a key, defines if the UID or the random ID is sent back
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_SetConfiguration(
        void *pDataParams,                                                      /**< [In] Pointer to this layer's parameter structure. */
...
#define PHAL_MFDFEVX_GET_CARD_UID_OPTION_NUID_NOT_RETURNED              0x00U   /**< Option for no retun of 4 byte NUID from PICC. */
#define PHAL_MFDFEVX_GET_CARD_UID_OPTION_NUID_RETURNED                  0x01U   /**< Option for retun of 4 byte NUID from PICC. */
/** @} */
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_GetCardUID(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_ChangeKey(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
        uint16_t wOption,                                                       /**< [In] One of the below options.
                                                                                 *          \arg #PHAL_MFDFEVX_NO_DIVERSIFICATION
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_ChangeKeyEv2(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
        uint16_t wOption,                                                       /**< [In] One of the below options.
                                                                                 *          \arg #PHAL_MFDFEVX_NO_DIVERSIFICATION
                                                                                 *          \arg #PHAL_MFDFEVX_CHGKEY_DIV_NEW_KEY | #PHAL_MFDFEVX_CHGKEY_DIV_METHOD_CMAC
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_InitializeKeySet(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
        uint8_t bKeySetNo,                                                      /**< [In] Key set number within targeted application.
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_FinalizeKeySet(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
        uint8_t bKeySetNo,                                                      /**< [In] Key set number within targeted application.
                                                                                 *        ORed with #PHAL_MFDFEVX_SAI to indicate secondary application indicator.
                                                                                 */
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t  phalMfdfEVx_RollKeySet(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
        uint8_t bKeySetNo                                                       /**< [In] Key set number within targeted application.
                                                                                 *        ORed with #PHAL_MFDFEVX_SAI to indicate secondary application indicator.
                                                                                 */
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_GetKeyVersion(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_GetDFNames(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
        uint8_t bOption,                                                        /**< [In] One of the below options.
                                                                                 *          \arg #PH_EXCHANGE_DEFAULT
                                                                                 *          \arg #PH_EXCHANGE_RXCHAINING
...
/** @{ */
#define PHAL_MFDFEVX_CREATE_TMAC_FILE_DIV_OFF                           0x00U   /**< Option to disable key diversification. */
#define PHAL_MFDFEVX_CREATE_TMAC_FILE_DIV_ON                            0x01U   /**< Option to enable key diversification. */
/** @} */
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_CreateTransactionMacFile(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_IsoExternalAuthenticate(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_IsoInternalAuthenticate(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
        uint8_t * pInput,                                                       /**< [In] Input data should be as mentioned below.
                                                                                 *          \c Reference to crypto algorigthm - 1 Byte: 00 => context defined, 02 => 2K3DES,
                                                                                 *                                                      04 => 3k3DES, 09 => AES128 \n
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_IsoAuthenticate(
        void * pDataParams,                                                     /**< [In] Pointer to this layer's parameter structure. */
 ...
 * call \ref phalMfdfEVx_ComputeMFCLicenseMAC command.
 *
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_RestrictMFCUpdate(
        void * pDataParams,                                                     /**< [In] Pointer to this layers parameter structure. */
        uint8_t bOption,                                                        /**< [In] Configuration Option. Define length and content of the Data parameter. */
        uint8_t * pMFCConfig,                                                   /**< [In] Data content depends on option values. */
        uint8_t bMFCConfigLen,                                                  /**< [In] Length of Bytes available in MFCConfig buffer. */
        uint8_t * pMFCLicense,                                                  /**< [In] MIFARE Classic License. Should be as follows
                                                                                 *          \c BlockCount || BlockNr1 || BlockOption1 [|| BlockNr2 || BlockOption2 || ...
                                                                                 *             || BlockNrN || BlockOptionN]
                                                                                 */
...
/**
 * \defgroup phalMfdfEVx_PDC Commands_PostDeliveryConfiguration
 ...
 */
phStatus_t phalMfdfEVx_AuthenticatePDC(
        void * pDataParams,                                                     /**< [In] Pointer to this layers parameter structure. */
        uint8_t bRfu,                                                           /**< [In] The RFU information. Its zero by default. */
        uint8_t bKeyNoCard,                                                     /**< [In] PICC Key number to be used for authentication. */
        uint8_t wKeyNo,                                                         /**< [In] Key number to used from software or hardware keystore. */
        uint16_t wKeyVer,                                                       /**< [In] Key version to used from software or hardware keystore. */
        uint8_t bUpgradeInfo                                                    /**< [In] The upgrade info input. */
    );

/**
 * end of group phalMfdfEVx_PDC
 * @}
 */
#endif /* NXPBUILD__PHAL_MFDFEVX_NDA */
 ...
 *  \c KeyNoDAMEnc should be off Offline_Crypto Keyclass.
 *
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_GenerateDAMEncKey(
        void * pDataParams,                                                     /**< [In] Pointer to this layers parameter structure. */
...
/**
 * \brief Generate MAC for Delegated applicatiom management.
 * While using this command in SAM mode make sure the below points are taken care\n
 *  \c KeyNoDAMMAC should be off Offline_Crypto Keyclass.
 *
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_GenerateDAMMAC(
        void * pDataParams,                                                     /**< [In] Pointer to this layers parameter structure. */
        uint8_t bOption,                                                        /**< [In] Option to represent the present of ISO information.
                                                                                 *          \arg #PHAL_MFDFEVX_ISO_FILE_INFO_NOT_AVAILABLE
                                                                                 *          \arg #PHAL_MFDFEVX_ISO_FILE_ID_AVAILABLE
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_GenerateDAMMACSetConfig(
        void * pDataParams,                                                     /**< [In] Pointer to this layers parameter structure. */
        uint16_t wKeyNoDAMMAC,                                                  /**< [In] Key number in key store of DAM MAC Key */
        uint16_t wKeyVerDAMMAC,                                                 /**< [In] Key version in key store of DAM MAC Key*/
 ...
 * While using this command in SAM mode make sure the below points are taken care\n
 *  \c KeyNoTMACKey and RamKeyNo should be off Offline_Crypto Keyclass.
 *
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_CalculateTMV(
        void * pDataParams,                                                     /**< [In] Pointer to this layers parameter structure. */
        ...
        uint32_t dwTMILen,                                                      /**< [In] Length of bytes available in TMI buffer. */
 ...
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_DecryptReaderID(
        void * pDataParams,                                                     /**< [In] Pointer to this layers parameter structure. */
        uint16_t wOption,                                                       /**< [In] Diversification option.
                                                                                 *          \arg #PHAL_MFDFEVX_DIVERSIFICATION_OFF
                                                                                 *          \arg #PHAL_MFDFEVX_DIVERSIFICATION_ON
 ...
 * While using this command in SAM mode make sure the below points are taken care\n
 *  \c MFCLicenseMACKeyNo should be off Offline_Crypto Keyclass.
 *
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_ComputeMFCLicenseMAC(
        void * pDataParams,                                                     /**< [In] Pointer to this layers parameter structure. */
        uint16_t wOption,                                                       /**< [In] Diversification Option.
                                                                                 *          \arg #PHAL_MFDFEVX_NO_DIVERSIFICATION
                                                                                 *          \arg #PHAL_MFDFEVX_DIV_METHOD_CMAC
                                                                                 */
        uint16_t wMFCLicenseMACKeyNo,                                           /**< [In] Key number in key store for MFCLicenseMAC calculation. */
        uint16_t wMFCLicenseMACKeyVer,                                          /**< [In] Key version in key store for MFCLicenseMAC calculation. */
        uint8_t * pInput,                                                       /**< [In] The input for which the MAC should be computed. Input should be as follows.
                                                                                 *          \c 0x01 || MFCLicense || MFCSectorSecrets
                                                                                 */
        uint16_t wInputLen,                                                     /**< [In] Length of Bytes available in MFCLicenseMACIn buffer. */
        ...
        uint8_t * pMFCLicenseMAC                                                /**< [Out] The computed MFCLicense MAC. */
    );

/** \name Options for SDM information. */
/** @{ */
#define PHAL_MFDFEVX_VCUID_PRESENT                                      0x80U   /**< Only VCUID is considred for SDM Session key calculation */
#define PHAL_MFDFEVX_RDCTR_PRESENT                                      0x40U   /**< Only RDCTR  is considred for SDM Session key calculation */
/** @} */

/**
 * \brief Calculate MAC SDM
 * While using this command in SAM mode make sure the below points are taken care\n
 *  \c SDMMacKeyNo and RamKeyNo should be off Offline_Crypto Keyclass.
 *
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_CalculateMACSDM(
        void * pDataParams,                                                     /**< [In] Pointer to this layers parameter structure. */
        uint8_t bSdmOption,                                                     /**< [In] SDM Option to indicate which parameters to be considered.
                                                                                 ...
                                                                                 */
        uint16_t wSDMMacKeyNo,                                                  /**< [In] Key number to be used from software or hardware keystore. */
        uint16_t wSDMMacKeyVer,                                                 /**< [In] Key version to be used from software or hardware keystore. */
        uint16_t wRamKeyNo,                                                     /**< [In] Key number of Destination Key where the computed session TMAC key will be stored.
                                                                                 *        To be used for SAM AV3 only.
                                                                                 */
        uint16_t wRamKeyVer,                                                    /**< [In] Key version of Destination Key where the computed session TMAC key will be stored.
                                                                                 ...
                                                                                 */
        uint8_t * pUid,                                                         /**< [In] UID of the card. */
        uint8_t bUidLen,                                                        /**< [In] Length of bytes available in pUid buffer. */
        uint8_t * SDMReadCtr,                                                   /**< [In] SDM Read Counter Input. */
        ...
        uint8_t * pRespMac                                                      /**< [Out] Computed SDM MAC. */
    );

/**
 * \brief Decrypt SDM enciphered data.
 * While using this command in SAM mode make sure the below points are taken care\n
 *  \c EncKeyNo and RamKeyNo should be off Offline_Crypto Keyclass.
 *
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_DecryptSDMENCFileData(
        void * pDataParams,                                                     /**< [In] Pointer to this layers parameter structure. */
        uint8_t bSdmOption,                                                     /**< [In] SDM Option to indicate which parameters to be considered.
                                                                                 *          \arg #PHAL_MFDFEVX_VCUID_PRESENT
                                                                                 *          \arg #PHAL_MFDFEVX_RDCTR_PRESENT
                                                                                 */
        uint16_t wEncKeyNo,                                                     /**< [In] Key number to be used from software or hardware keystore. */
        uint16_t wEncKeyVer,                                                    /**< [In] Key version to be used from software or hardware keystore. */
        uint16_t wRamKeyNo,                                                     /**< [In] Key number of Destination Key where the computed session TMAC key will be stored.
                                                                                 *        To be used for SAM AV3 only.
                                                                                 */
        uint16_t wRamKeyVer,                                                    /**< [In] Key version of Destination Key where the computed session TMAC key will be stored.
        ...
        uint8_t * pEncdata,                                                     /**< [In] Encrpted NonASCII SDM Encrypted File data. */
        uint16_t wInDataLen,                                                    /**< [In] Length of bytes available in EncData buffer. */
        uint8_t * pPlainData                                                    /**< [Out] The decrypted SDMFile data. */
    );

/**
 * \brief Decrypt SDM PICC Data.
 * While using this command in SAM mode make sure the below points are taken care\n
 *  \c KeyNo should be off Offline_Crypto Keyclass.
 *
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 * \retval Other Depending on implementation and underlying component.
 */
phStatus_t phalMfdfEVx_DecryptSDMPICCData(
        void * pDataParams,                                                     /**< [In] Pointer to this layers parameter structure. */
        ...
        uint8_t * pEncdata,                                                     /**< [In] Encrpted NonASCII SDM PICC data. */
        uint16_t wInDataLen,                                                    /**< [In] Length of bytes available in EncData buffer. */
