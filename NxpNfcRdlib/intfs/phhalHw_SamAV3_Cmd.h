...
/** \file
* Generic SAMAV3 Component of Reader Library Framework.
* $Author: NXP $
* $Revision: $ (v07.10.00)
* $Date: $
*
...
#define PHHAL_HW_SAMAV3_CMD_GET_VERSION_RESPONSE_LENGTH             0x1FU   /**< Response length for GetVersion command */
#define PHHAL_HW_SAMAV3_CMD_GET_VERSION_RESPONSE_UID_OFFSET         0x0EU   /**< Offset of first UID byte field in the Version field */
#define PHHAL_HW_SAMAV3_CMD_GET_VERSION_RESPONSE_HOSTMODE_POS       0x1EU   /**< Offset of first UID byte field in the Version field */
 ...
 * \brief Defines used across the whole SAM implementation for the status codes returned by Sam hardware.
 * @{
 */
...
#define PHHAL_HW_SAMAV3_RET_CODE_ISO7816_WRONG_PARAMS_FOR_INS       0x6A80  /**< Wrong data field parameter. */
 ...
 * \brief SamAV3 Custom Error Codes for the respective status codes returned by Sam hardware.
 * @{
 */
...
phStatus_t phhalHw_SamAV3_Cmd_SAM_GetRandom(
        phhalHw_SamAV3_DataParams_t * pDataParams,                          /**< [In] Pointer to this layer's parameter structure. */
        uint8_t    bExpLen,                                                 /**< [In] The length of random bytes expected form Sam hardware. */
...
/**\cond HAL_SAMAV3_VCA_X_INTERNAL
...
/**\cond HAL_SAMAV3_MFD_X_INTERNAL
...
/**\cond HAL_SAMAV3_MFP_X_INTERNAL
...
/**\cond HAL_SAMAV3_MFC_X_INTERNAL
...
/** @{ */
#define PHHAL_HW_SAMAV3_CMD_SAM_PWD_AUTH_UL_INS                 0x0B    /**< Sam AV3 S mode Instruction code for PwdAuthUL command. */
/** @} */
...
/**\cond HAL_SAMAV3_MFUL_X_INTERNAL
...
/**\cond HAL_SAMAV3_COMMON_X_INTERNAL
...
/** \name Option macros for PLExec and PLUpload command's P1 information byte. */
/** @{ */
...
/** @{ */
#define PHHAL_HW_SAMAV3_CMD_RC_READ_REGISTER_INS                    0xEE    /**< Sam AV3 Instruction code for RC_ReadRegister command. */
#define PHHAL_HW_SAMAV3_CMD_RC_WRITE_REGISTER_INS                   0x1E    /**< Sam AV3 Instruction code for RC_WriteRegister command. */
#define PHHAL_HW_SAMAV3_CMD_RC_RF_CONTROL_INS                       0xCF    /**< Sam AV3 Instruction code for RC_RFControl command. */
#define PHHAL_HW_SAMAV3_CMD_RC_INIT_INS                             0xE5    /**< Sam AV3 Instruction code for RC_Int command. */
#define PHHAL_HW_SAMAV3_CMD_RC_LOAD_REGISTER_VALUE_SET_INS          0x2E    /**< Sam AV3 Instruction code for RC_LoadRegisterValueSet command. */
/** @} */
...
/**\cond HAL_SAMAV3_ISO14443_3_X_INTERNAL
...
/**\cond HAL_SAMAV3_ISO14443_4_X_INTERNAL
