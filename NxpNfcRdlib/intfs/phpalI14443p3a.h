...
typedef struct
{
    ...
    uint8_t bSkipTOSet;     /**< Skip the timeout setting while sending VAS Command. */
...
#ifdef NXPBUILD__PHPAL_I14443P3A_SW_ECP
/**
 * Skip configuration of timeout in VAS Command. This shall be used by upper
 * layers to not set the timeout for VAS command instead upper layer will
 * configure the timeout.
 * */
#define PHPAL_I14443P3A_CONFIG_SKIP_SETTING_TIMEOUT 0x004U
#endif /* NXPBUILD__PHPAL_I14443P3A_SW_ECP */
/*@}*/
...
#ifdef NXPBUILD__PHPAL_I14443P3A_SW_ECP
/**
* \brief Perform a ECP VASUP-A command.
*
* \b Note: The "Request Guard Time" is configured by the application or higher layer.
* As this is not defined by ECP Specification v1.1.
*
* \return Status code
* \retval #PH_ERR_SUCCESS Operation successful.
* \retval #PH_ERR_PROTOCOL_ERROR Invalid response received.
...
phStatus_t phpalI14443p3a_VASUpA(
                                 void * pDataParams,    /**< [In] Pointer to this layer's parameter structure. */
                                 uint8_t  bFormatByte,  /**< [In] Format Byte of VASUP-A Command.  */
                                 uint8_t  * pCmdBytes,  /**< [In] Pointer to rest of the VASUP-A Command bytes. */
                                 uint8_t  bLenCmdBytes, /**< [In] Length of VASUP-A Command bytes excluding FormatByte.  */
                                 uint8_t *pAtqa         /**< [Out] AtqA; uint8_t[2]. */
                                 );
#endif /* NXPBUILD__PHPAL_I14443P3A_SW_ECP */
