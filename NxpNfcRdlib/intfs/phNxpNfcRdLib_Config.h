...
#define PH_NXPNFCRDLIB_CONFIG_SAM_AV3_HAL_TX_BUFFSIZE            262U       /**< Maximum SAM AV3 HAL Tx buffer size allocated by Simplified API Layer. */
#define PH_NXPNFCRDLIB_CONFIG_SAM_AV3_HAL_RX_BUFFSIZE            262U       /**< Maximum SAM AV3 HAL Rx buffer size allocated by Simplified API Layer. */
