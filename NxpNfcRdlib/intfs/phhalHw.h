...
typedef struct
{
    ...
    uint8_t bOpMode;                                                                            /**< Operation mode. \arg #PHHAL_HW_SAMAV3_OPMODE_NON_X */
...
phStatus_t phhalHw_SamAV3_Init(
        ...
        uint8_t bOpMode,                                                                        /**< [In] The desired operation mode. \arg #PHHAL_HW_SAMAV3_OPMODE_NON_X */
...
#define PHHAL_HW_PN76XX_DEFAULT_FELICA_EMD_REGISTER     0x00FF0019U  /**< FeliCa EMD Control register default value */
    ...
    #define PHHAL_HW_PN76XX_SET_LISTEN_EEPROM_ADDR      0x2B3U       /**< PN7640 Autocoll config Parameters EEPROM address is 0x2B3U. */
    #define PHHAL_HW_PN76XX_DYNAMIC_UID_CONFG_ADDR      0x2CBU       /**< PN7640 Card mode Dynamic UID configuration address is 0x2CBU. */
#endif /* NXPBUILD__PHHAL_HW_PN7640 */

#ifdef NXPBUILD__PHHAL_HW_PN7642
    #define PHHAL_HW_PN76XX_SET_LISTEN_EEPROM_ADDR      0x3C5U       /**< PN7642 Autocoll config Parameters EEPROM address is 0x3C5U. */
    #define PHHAL_HW_PN76XX_DYNAMIC_UID_CONFG_ADDR      0x3DDU       /**< PN7642 Card mode Dynamic UID configuration address is 0x3DDU. */
...
typedef struct phhalHw_PN76xx_DataParams
{
    ...
    uint8_t* pTxBuffer;             /**< Pointer to global transmit buffer used by the Exchange() function. */
    uint16_t wTxBufSize;            /**< Size of the global transmit buffer. */
    uint16_t wTxBufLen;             /**< Size of the buffer transmitted */
    uint8_t* pRxBuffer;             /**< Pointer to global receive buffer used by the Exchange() function. */
    uint16_t wRxBufSize;            /**< Size of the global receive buffer. */
    uint16_t wRxBufLen;             /**< Number of valid bytes within the receive buffer. */
    uint16_t wTxBufStartPos;        /**< Starting position within the global transmit buffer (used if \b TxBuffer equals \b RxBuffer). */
