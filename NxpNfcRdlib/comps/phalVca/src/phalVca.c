...
#include "Sam_NonX/phalVca_Sam_NonX.h"
    ...
    uint8_t * pResponse, uint16_t * pRespLen)
{
    ...
    switch(PH_GET_COMPID(pDataParams))
    {
        ...
        case PHAL_VCA_SAMAV3_NONX_ID:
            status = phalVca_Sam_NonX_IsoSelect((phalVca_SamAV3_NonX_DataParams_t *) pDataParams, bSelectionControl, bOption,
                bDFnameLen, pDFname, pDivInput, bDivInputLen, bEncKeyNo, bEncKeyVer, bMacKeyNo, bMacKeyVer, pResponse, pRespLen);
            break;
...
#ifdef NXPBUILD__PHAL_VCA_SAMAV3_NONX
        case PHAL_VCA_SAMAV3_NONX_ID:
            status = phalVca_Sam_NonX_IsoExternalAuthenticate((phalVca_SamAV3_NonX_DataParams_t *) pDataParams, pInData);
            break;
#endif /* NXPBUILD__PHAL_VCA_SAMAV3_NONX */
...
#ifdef NXPBUILD__PHAL_VCA_SAMAV3_NONX
        case PHAL_VCA_SAMAV3_NONX_ID:
            status = phalVca_Sam_NonX_ProximityCheckNew((phalVca_SamAV3_NonX_DataParams_t *) pDataParams, bOption, pPrndC, bNumSteps, wKeyNumber,
                wKeyVersion, pDivInput, bDivInputLen, pOption, pPubRespTime, pResponse, pRespLen, pCumRndRC);
            break;
#endif /* NXPBUILD__PHAL_VCA_SAMAV3_NONX */
#endif /* NXPBUILD__PHAL_VCA_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_VCA_SAMAV3_NONX
        case PHAL_VCA_SAMAV3_NONX_ID:
            status = PH_ADD_COMPCODE(PH_ERR_UNSUPPORTED_COMMAND, PH_COMP_AL_VCA);
            break;
#endif /* NXPBUILD__PHAL_VCA_SAMAV3_NONX */
#endif /* NXPBUILD__PHAL_VCA_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_VCA_SAMAV3_NONX
        case PHAL_VCA_SAMAV3_NONX_ID:
            status = PH_ADD_COMPCODE_FIXED(PH_ERR_UNSUPPORTED_COMMAND, PH_COMP_AL_VCA);
            break;
#endif /* NXPBUILD__PHAL_VCA_SAMAV3_NONX */
#endif /* NXPBUILD__PHAL_VCA_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_VCA_SAMAV3_NONX
        case PHAL_VCA_SAMAV3_NONX_ID:
            status = phalVca_Sam_NonX_SetConfig((phalVca_SamAV3_NonX_DataParams_t *) pDataParams, wConfig, wValue);
            break;
#endif /* NXPBUILD__PHAL_VCA_SAMAV3_NONX */
#endif /* NXPBUILD__PHAL_VCA_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_VCA_SAMAV3_NONX
        case PHAL_VCA_SAMAV3_NONX_ID:
            status = phalVca_Sam_NonX_GetConfig((phalVca_SamAV3_NonX_DataParams_t *) pDataParams, wConfig, pValue);
            break;
#endif /* NXPBUILD__PHAL_VCA_SAMAV3_NONX */
#endif /* NXPBUILD__PHAL_VCA_SAM_NONX */
