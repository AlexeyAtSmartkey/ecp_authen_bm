...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
    /* Guard times */
    pDataParams->waPasPollGTimeUs[PHAC_DISCLOOP_TECH_TYPE_VAS]       = PH_NXPNFCRDLIB_CONFIG_PRE_PTGTV;
    pDataParams->bPasPollTechCfg                                     |= (PHAC_DISCLOOP_POS_BIT_MASK_VAS);
    pDataParams->sVASTargetInfo.bFormatByte   = 0x01;
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
            || (((uint8_t)wValue & PHAC_DISCLOOP_POS_BIT_MASK_VAS) == PHAC_DISCLOOP_POS_BIT_MASK_VAS)
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
            )
        {
...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
    case PHAC_DISCLOOP_CONFIG_GTVAS_VALUE_US:
        pDataParams->waPasPollGTimeUs[PHAC_DISCLOOP_TECH_TYPE_VAS] = wValue;
        break;
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
    case PHAC_DISCLOOP_CONFIG_VASUP_A_FORAMT_BYTE:
        pDataParams->sVASTargetInfo.bFormatByte = (uint8_t)wValue;
        break;
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
