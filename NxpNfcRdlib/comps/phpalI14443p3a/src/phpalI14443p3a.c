...
phStatus_t phpalI14443p3a_VASUpA(
                                 ...
                                 uint8_t  bFormatByte,
                                 uint8_t  * pCmdBytes,
                                 uint8_t  bLenCmdBytes,
                                 uint8_t *pAtqa
                                 )
{
    phStatus_t PH_MEMLOC_REM status;

    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phpalI14443p3a_VASUpA");
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(bFormatByte);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(pCmdBytes);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(bLenCmdBytes);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(pAtqa);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(status);
    PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
    PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
