...
#ifdef NXPBUILD__PHPAL_I14443P3A_SW_ECP
    case PHPAL_I14443P3A_CONFIG_SKIP_SETTING_TIMEOUT:
    {
       pDataParams->bSkipTOSet = (uint8_t)wValue;
       break;
    }
#endif /* NXPBUILD__PHPAL_I14443P3A_SW_ECP */
                                     ...
                                     )
{
    ...
    {
        if ((bLenCmdBytes > 18U) || (bLenCmdBytes < 3U) || ((pCmdBytes[0] & 0x0FU) != (bLenCmdBytes - 3U)))
        {
            return PH_ADD_COMPCODE_FIXED(PH_ERR_INVALID_PARAMETER, PH_COMP_PAL_ISO14443P3A);
        }
    }
