...
#include "Sam_NonX/phalMful_Sam_NonX.h"
    ...
    uint8_t bDivInputLen)
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        status = phalMful_Sam_NonX_UlcAuthenticate(pDataParams, bOption, wKeyNo, wKeyVer, pDivInput, bDivInputLen);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                          ...
                          )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_Write(pDataParams, bAddress, pData);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                              ...
                              )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_FastWrite(pDataParams,  pData);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                         ...
                         )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
#endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_Read(pDataParams, bAddress, pData);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                                       ...
                                       )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_CompatibilityWrite(pDataParams, bAddress, pData);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                            ...
                            )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_IncrCnt(pDataParams, bCntNum, pCnt);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                            ...
                            )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_ReadCnt(pDataParams, bCntNum, pCntValue);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
    ...
    uint8_t bDivInputLen, uint8_t * pPwd, uint8_t * pPack)
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_PwdAuth(pDataParams, bOption, bKeyNo, bKeyVer, pDivInput, bDivInputLen, pPwd, pPack);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                               ...
                               )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_GetVersion(pDataParams, pVersion);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                             ...
                             )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_FastRead(pDataParams, bStartAddr, bEndAddr, ppData, pNumBytes);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                                 ...
                                 )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_SectorSelect(pDataParams, bSecNo);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                             ...
                             )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_ReadSign(pDataParams, bAddr, pSignature, &wDataLen);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                                    ...
                                    )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_ChkTearingEvent(pDataParams, bCntNum, pValidFlag);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                              ...
                              )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_WriteSign(pDataParams, bAddress, pSignature);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                             ...
                             )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_LockSign(pDataParams, bLockMode);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
                                      ...
                                      )
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_VirtualCardSelect(pDataParams, pVCIID, bVCIIDLen, pVCTID);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
...
phStatus_t phalMful_ReadTTStatus(void * pDataParams, uint8_t  bAddr, uint8_t * pData)
{
    ...
    case PHAL_MFUL_SW_ID:
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_ReadTTStatus(pDataParams, bAddr, pData);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
...
phStatus_t phalMful_GetConfig(void * pDataParams, uint16_t wConfig, uint16_t * pValue)
{
    ...
    switch(PH_GET_COMPID(pDataParams))
    {
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
            status = phalMful_Sam_NonX_GetConfig(pDataParams, wConfig, pValue);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
...
phStatus_t phalMful_SetConfig(void * pDataParams, uint16_t wConfig, uint16_t wValue)
{
    ...
    switch(PH_GET_COMPID(pDataParams))
    {
        ...
        case PHAL_MFUL_SAMAV3_NONX_ID:
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
        status = phalMful_Sam_NonX_SetConfig(pDataParams, wConfig, wValue);
        break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
    ...
    uint8_t * pDivInput, uint8_t bDivLen)
{
    ...
    #ifdef NXPBUILD__PHAL_MFUL_SAMAV3_NONX
        case PHAL_MFUL_SAMAV3_NONX_ID:
        status = phalMful_Sam_NonX_AuthenticateAES((phalMful_SamAV3_NonX_DataParams_t *)pDataParams, bOption, wKeyNo, wKeyVer, bRamKeyNo, bRamKeyVer,
...
phStatus_t phalMful_CalculateSunCMAC(void * pDataParams, uint16_t wKeyNo, uint16_t wKeyVer, uint8_t * pInData, uint16_t wInDataLen, uint8_t * pRespMac)
{
    ...
    #ifdef NXPBUILD__PHAL_MFUL_SAMAV3_NONX
        case PHAL_MFUL_SAMAV3_NONX_ID:
        status = phalMful_Sam_NonX_CalculateSunCMAC(pDataParams,wKeyNo,  wKeyVer,  pInData, wInDataLen, pRespMac);
        break;
    #endif /* NXPBUILD__PHAL_MFUL_SAMAV3_NONX */
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
