...
#include "Sam_NonX/phalMfdfEVx_Sam_NonX.h"
...
phStatus_t phalMfdfEVx_Authenticate(void * pDataParams, uint16_t wOption, uint16_t wKeyNo, uint16_t wKeyVer, uint8_t bKeyNoCard,
    uint8_t * pDivInput, uint8_t bDivLen)
{
    ...
    if(bDivLen) PH_ASSERT_NULL_PARAM(pDivInput, PH_COMP_AL_MFDFEVX);
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_Authenticate(pDataParams, wOption, wKeyNo, wKeyVer, bKeyNoCard, pDivInput, bDivLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
phStatus_t phalMfdfEVx_AuthenticateISO(void * pDataParams, uint16_t wOption, uint16_t wKeyNo, uint16_t wKeyVer, uint8_t bKeyNoCard,
    uint8_t * pDivInput, uint8_t bDivLen)
{
    /**
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_AuthenticateISO(pDataParams, wOption, wKeyNo, wKeyVer, bKeyNoCard, pDivInput, bDivLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
phStatus_t phalMfdfEVx_AuthenticateAES(void * pDataParams, uint16_t wOption, uint16_t wKeyNo, uint16_t wKeyVer, uint8_t bKeyNoCard,
    uint8_t * pDivInput, uint8_t bDivLen)
{
    /**
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_AuthenticateAES(pDataParams, wOption, wKeyNo, wKeyVer, bKeyNoCard, pDivInput, bDivLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
phStatus_t phalMfdfEVx_AuthenticateEv2(void *pDataParams, uint8_t bFirstAuth, uint16_t wOption, uint16_t wKeyNo, uint16_t wKeyVer,
    uint8_t bKeyNoCard, uint8_t * pDivInput, uint8_t bDivLen, uint8_t bLenPcdCapsIn, uint8_t *bPcdCapsIn, uint8_t *bPcdCapsOut,
    uint8_t *bPdCapsOut)
{
    phStatus_t PH_MEMLOC_REM status;
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_AuthenticateEv2(pDataParams, bFirstAuth, wOption, wKeyNo, wKeyVer, bKeyNoCard, pDivInput,
                bDivLen, bPcdCapsIn, bLenPcdCapsIn, bPcdCapsOut, bPdCapsOut);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_FreeMem(pDataParams, pMemInfo);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_FormatPICC(pDataParams);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_SetConfiguration(pDataParams, bOption, pData, bDataLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetVersion(pDataParams, pVerInfo, &bVerLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetCardUID(pDataParams, bExchangeOption, bOption, pUid, &bCardUidLength);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_NDA
phStatus_t phalMfdfEVx_ChangeKey(void * pDataParams, uint16_t wOption, uint16_t wOldKeyNo, uint16_t wOldKeyVer, uint16_t wNewKeyNo,
    uint16_t wNewKeyVer, uint8_t bKeyNoCard, uint8_t * pDivInput, uint8_t bDivLen)
{
    ...
    */
    ...
    /* Validate the parameters */
    PH_ASSERT_NULL_DATA_PARAM(pDataParams, PH_COMP_AL_MFDFEVX);
    if(bDivLen > 0)PH_ASSERT_NULL_PARAM(pDivInput, PH_COMP_AL_MFDFEVX);
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_ChangeKey(pDataParams, wOption, wOldKeyNo, wOldKeyVer, wNewKeyNo, wNewKeyVer,
                bKeyNoCard, pDivInput, bDivLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
phStatus_t phalMfdfEVx_ChangeKeyEv2(void * pDataParams, uint16_t wOption, uint16_t wOldKeyNo, uint16_t wOldKeyVer, uint16_t wNewKeyNo,
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_ChangeKeyEv2(pDataParams, wOption, wOldKeyNo, wOldKeyVer, wNewKeyNo, wNewKeyVer, bKeySetNo,
                bKeyNoCard, pDivInput, bDivLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_InitializeKeySet(pDataParams, bKeySetNo, bKeyType);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_FinalizeKeySet(pDataParams, bKeySetNo, bKeySetVersion);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_RollKeySet(pDataParams, bKeySetNo);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetKeySettings(pDataParams, pKeySettings, bRespLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_ChangeKeySettings(pDataParams, bKeySettings);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetKeyVersion(pDataParams, bKeyNo, bKeySetNo, pKeyVersion, bRxLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CreateApplication(pDataParams, bOption, pAid, bKeySettings1, bKeySettings2, bKeySettings3, pKeySetValues,
                pISOFileId, pISODFName, bISODFNameLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_DeleteApplication(pDataParams, pAid, pDAMMAC, bDAMMAC_Len);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CreateDelegatedApplication(pDataParams, bOption, pAid, pDamParams, bKeySettings1,
                bKeySettings2, bKeySettings3, bKeySetValues, pISOFileId, pISODFName, bISODFNameLen, pEncK, pDAMMAC);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_SelectApplication(pDataParams, bOption, pAid, pAid2);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetApplicationIDs(pDataParams, bOption, pAidBuff, pNumAIDs);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_NDA
phStatus_t phalMfdfEVx_GetDFNames(void * pDataParams, uint8_t bOption, uint8_t * pDFBuffer, uint8_t * pDFInfoLen)
{
    /*
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetDFNames(pDataParams, bOption, pDFBuffer, pDFInfoLen);
            break;
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetDelegatedInfo(pDataParams, pDAMSlot, pDamSlotVer, pQuotaLimit, pFreeBlocks, pAid);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CreateStdDataFile(pDataParams, bOption, bFileNo, pISOFileId, bFileOption,
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CreateBackupDataFile(pDataParams, bOption, bFileNo, pISOFileId, bFileOption,
                pAccessRights, pFileSize);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CreateValueFile(pDataParams, bFileNo, bCommSett, pAccessRights, pLowerLmit, pUpperLmit, pValue,
                bLimitedCredit);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CreateLinearRecordFile(pDataParams, bOption, bFileNo, pIsoFileId,
            bCommSett, pAccessRights, pRecordSize, pMaxNoOfRec);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CreateCyclicRecordFile(pDataParams, bOption, bFileNo, pIsoFileId, bCommSett,
                pAccessRights, pRecordSize, pMaxNoOfRec);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_NDA
phStatus_t phalMfdfEVx_CreateTransactionMacFile(void * pDataParams, uint16_t wOption, uint8_t bFileNo, uint8_t bCommSett, uint8_t * pAccessRights,
    uint16_t wKeyNo, uint8_t bKeyType, uint8_t * bTMKey, uint8_t bTMKeyVer, uint8_t * pDivInput, uint8_t bDivInputLength)
{
    phStatus_t PH_MEMLOC_REM status;
    ...
    if(pDivInput != NULL) PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pDivInput_log, pDivInput, bDivInputLength);
    ...
    if(bDivInputLength) PH_ASSERT_NULL_PARAM(pDivInput, PH_COMP_AL_MFDFEVX);
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CreateTransactionMacFile(pDataParams, bFileNo, bCommSett, pAccessRights,
                wKeyNo, bTMKeyVer, bKeyType, bTMKey, pDivInput, bDivInputLength);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_DeleteFile(pDataParams, bFileNo);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetFileIDs(pDataParams, pFid, bNumFID);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetISOFileIDs(pDataParams, pFidBuffer, pNumFID);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetFileSettings(pDataParams, bFileNo, pFSBuffer, bBufferLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetFileCounters(pDataParams, bOption, bFileNo, pFileCounters, pRxLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_ChangeFileSettings(pDataParams, bOption, bFileNo, bFileOption, pAccessRights,
                bAddInfoLen, pAddInfo);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_ReadData(pDataParams, bOption, bIns, bFileNo, pOffset, pLength,
                ppRxdata, pRxdataLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_WriteData(pDataParams, bOption, bIns, bFileNo, pOffset, pTxData, pTxDataLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetValue(pDataParams, bOption, bFileNo, pValue);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_Credit(pDataParams, bOption, bFileNo, pValue);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_Debit(pDataParams, bCommOption, bFileNo, pValue);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_LimitedCredit(pDataParams, bCommOption, bFileNo, pValue);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_WriteRecord(pDataParams, bCommOption, bIns, bFileNo, pOffset, pData, pDataLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_ReadRecords(pDataParams, bCommOption, bIns, bFileNo, pRecNo, pRecCount, pRecSize,
                ppRxdata, pRxdataLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_UpdateRecord(pDataParams, bCommOption, bIns, bFileNo, pRecNo, pOffset, pData, pDataLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_ClearRecordFile(pDataParams, bFileNo);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CommitTransaction(pDataParams, bOption, pTMC, pTMV);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_AbortTransaction(pDataParams);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CommitReaderID(pDataParams, pTMRI, pEncTMRI);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_IsoSelectFile(pDataParams, bOption, bSelector, pFid, pDFname, bDFnameLen,
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_IsoReadBinary(pDataParams, bOffset, bSfid, dwBytesToRead, bExtendedLenApdu,
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_IsoUpdateBinary(pDataParams, bOffset, bSfid, bExtendedLenApdu, pData, dwDataLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_IsoReadRecords(pDataParams, bRecNo, bReadAllFromP1, bSfid, dwBytesToRead, bExtendedLenApdu,
                ppRxBuffer, pBytesRead);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_IsoAppendRecord(pDataParams, bSfid, bExtendedLenApdu, pData, dwDataLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = PH_ADD_COMPCODE_FIXED(PH_ERR_UNSUPPORTED_COMMAND, PH_COMP_AL_MFDFEVX);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_IsoGetChallenge(pDataParams, bExtendedLenApdu, dwLe, pRPICC1);
            break;
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_NDA
phStatus_t phalMfdfEVx_IsoExternalAuthenticate(void * pDataParams, uint8_t * pInput, uint8_t bInputLen, uint8_t bExtendedLenApdu,
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_IsoExternalAuthenticate(pDataParams, pInput, bInputLen, bExtendedLenApdu, pDataOut,
                pOutLen);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
phStatus_t phalMfdfEVx_IsoInternalAuthenticate(void * pDataParams, uint8_t * pInput, uint8_t bInputLen, uint8_t bExtendedLenApdu,
    uint8_t * pDataOut, uint8_t * pOutLen)
{
    phStatus_t PH_MEMLOC_REM status;
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_IsoInternalAuthenticate(pDataParams, pInput, bInputLen, bExtendedLenApdu);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_IsoAuthenticate(pDataParams, wKeyNo, wKeyVer, bKeyNoCard, bIsPICCkey);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_ReadSign(pDataParams, bAddr, pSignature);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CreateMFCMapping(pDataParams, bCommOption, bFileNo, bFileOption, pMFCBlockList, bMFCBlocksLen,
                bRestoreSource, pMFCLicense, bMFCLicenseLen, pMFCLicenseMAC);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_RestoreTransfer(pDataParams, bCommOption ,bTargetFileNo, bSourceFileNo);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_NDA
phStatus_t phalMfdfEVx_RestrictMFCUpdate(void * pDataParams, uint8_t bOption, uint8_t * pMFCConfig, uint8_t bMFCConfigLen,
    uint8_t * pMFCLicense, uint8_t bMFCLicenseLen, uint8_t * pMFCLicenseMAC)
{
    ...
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, PH_LOG_VAR(pMFCConfig), pMFCConfig, bMFCConfigLen);
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_RestrictMFCUpdate(pDataParams, bOption, pMFCConfig, bMFCConfigLen, pMFCLicense,
                bMFCLicenseLen, pMFCLicenseMAC);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
phStatus_t phalMfdfEVx_AuthenticatePDC(void * pDataParams, uint8_t bRfu, uint8_t bKeyNoCard, uint8_t wKeyNo, uint16_t wKeyVer,
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SW
        case PHAL_MFDFEVX_SW_ID:
            status = phalMfdfEVx_Sw_AuthenticatePDC((phalMfdfEVx_Sw_DataParams_t *) pDataParams, bRfu, bKeyNoCard, wKeyNo,
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_AuthenticatePDC(pDataParams, bRfu, bKeyNoCard,wKeyNo, wKeyVer, bUpgradeInfo);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GetConfig(pDataParams, wConfig, pValue);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_SetConfig(pDataParams, wConfig, wValue);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_ResetAuthStatus(pDataParams);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDFEVX_NDA
phStatus_t phalMfdfEVx_GenerateDAMEncKey(void * pDataParams, uint16_t wKeyNoDAMEnc, uint16_t wKeyVerDAMEnc, uint16_t wKeyNoAppDAMDefault,
    uint16_t wKeyVerAppDAMDefault, uint8_t bAppDAMDefaultKeyVer, uint8_t * pDAMEncKey)
{
    ...
    PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_DEBUG, wKeyNoAppDAMDefault_log, &wKeyNoAppDAMDefault);
    PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_DEBUG, wKeyVerAppDAMDefault_log, &wKeyVerAppDAMDefault);
    PH_LOG_HELPER_ADDPARAM_UINT8(PH_LOG_LOGTYPE_DEBUG, bAppDAMDefaultKeyVer_log, &bAppDAMDefaultKeyVer);
    PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GenerateDAMEncKey(pDataParams, wKeyNoDAMEnc, wKeyVerDAMEnc, wKeyNoAppDAMDefault,
...
phStatus_t phalMfdfEVx_GenerateDAMMAC(void * pDataParams, uint8_t bOption, uint16_t wKeyNoDAMMAC, uint16_t wKeyVerDAMMAC, uint8_t * pAid,
    ...
    uint8_t * pISODFName, uint8_t bISODFNameLen, uint8_t * pEncK, uint8_t * pDAMMAC)
{
    ...
    if(bOption & 0x01) PH_ASSERT_NULL_PARAM(pISOFileId, PH_COMP_AL_MFDFEVX);
    if(bOption & 0x02) PH_ASSERT_NULL_PARAM(pISODFName, PH_COMP_AL_MFDFEVX);
    if(!(bOption & PHAL_MFDFEVX_GENERATE_DAMMAC_DELETE_APPLICATION))
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_GenerateDAMMAC(pDataParams, bOption, wKeyNoDAMMAC, wKeyVerDAMMAC, pAid, pDamParams, bKeySettings1,
                bKeySettings2, bKeySettings3, pKeySetValues, pISOFileId, pISODFName, bISODFNameLen, pEncK, pDAMMAC);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
phStatus_t phalMfdfEVx_GenerateDAMMACSetConfig(void  * pDataParams, uint16_t wKeyNoDAMMAC, uint16_t wKeyVerDAMMAC, uint16_t wOldDFNameLen,
...
phStatus_t phalMfdfEVx_CalculateTMV(void * pDataParams, uint16_t wOption, uint16_t wKeyNoTMACKey, uint16_t wKeyVerTMACKey,
    ...
    uint8_t bUidLen, uint8_t * pTMI, uint32_t dwTMILen, uint8_t * pTMV)
{
    ...
    /* Validate the parameters */
    PH_ASSERT_NULL_DATA_PARAM(pDataParams, PH_COMP_AL_MFDFEVX);
    if(bDivInputLen) PH_ASSERT_NULL_PARAM(pDivInput, PH_COMP_AL_MFDFEVX);
    PH_ASSERT_NULL_PARAM(pTMC, PH_COMP_AL_MFDFEVX);
    if(bUidLen) PH_ASSERT_NULL_PARAM(pUid, PH_COMP_AL_MFDFEVX);
    if(dwTMILen) PH_ASSERT_NULL_PARAM(pTMI, PH_COMP_AL_MFDFEVX);
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CalculateTMV(pDataParams, wKeyNoTMACKey, wKeyVerTMACKey, wRamKeyNo, wRamKeyVer, pTMC, pUid, bUidLen,
                pTMI, dwTMILen, pTMV);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
phStatus_t phalMfdfEVx_DecryptReaderID(void * pDataParams, uint16_t wOption, uint16_t wKeyNoTMACKey, uint16_t wKeyVerTMACKey,
    uint16_t wRamKeyNo, uint16_t wRamKeyVer, uint8_t * pDivInput, uint8_t bDivInputLen, uint8_t * pTMC, uint8_t * pUid,
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_DecryptReaderID(pDataParams, wKeyNoTMACKey, wKeyVerTMACKey, wRamKeyNo, wRamKeyVer, pTMC, pUid,
...
phStatus_t phalMfdfEVx_ComputeMFCLicenseMAC(void * pDataParams, uint16_t wOption, uint16_t wMFCLicenseMACKeyNo, uint16_t wMFCLicenseMACKeyVer,
    uint8_t * pInput, uint16_t wInputLen, uint8_t * pDivInput, uint8_t bDivInputLen, uint8_t * pMFCLicenseMAC)
{
    ...
    if (wOption != 0xFFFF) PH_ASSERT_NULL_DATA_PARAM(pDivInput, PH_COMP_AL_MFDFEVX);
    PH_ASSERT_NULL_DATA_PARAM(pMFCLicenseMAC, PH_COMP_AL_MFDFEVX);

    /* Log the information. */
    PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
    PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_DEBUG, PH_LOG_VAR(wOption), &wOption);
    PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_DEBUG, PH_LOG_VAR(wMFCLicenseMACKeyNo), &wMFCLicenseMACKeyNo);
    PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_DEBUG, PH_LOG_VAR(wMFCLicenseMACKeyVer), &wMFCLicenseMACKeyVer);
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_ComputeMFCLicenseMAC(pDataParams, wOption, wMFCLicenseMACKeyNo, wMFCLicenseMACKeyVer, pInput,
                wInputLen, pDivInput, bDivInputLen, pMFCLicenseMAC);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
...
phStatus_t phalMfdfEVx_CalculateMACSDM(void * pDataParams, uint8_t bSdmOption, uint16_t wSDMMacKeyNo, uint16_t wSDMMacKeyVer,
    uint16_t wRamKeyNo, uint16_t wRamKeyVer, uint8_t * pUid, uint8_t bUidLen, uint8_t * pSDMReadCtr, uint8_t * pInData, uint16_t wInDataLen, uint8_t * pRespMac)
{
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_CalculateMACSDM(pDataParams, bSdmOption, wSDMMacKeyNo, wSDMMacKeyVer, wRamKeyNo, wRamKeyVer, pUid, bUidLen, pSDMReadCtr,
...
phStatus_t phalMfdfEVx_DecryptSDMENCFileData(void * pDataParams, uint8_t bSdmOption, uint16_t wEncKeyNo, uint16_t wEncKeyVer,
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_DecryptSDMENCFileData(pDataParams, bSdmOption, wEncKeyNo, wEncKeyVer, wRamKeyNo, wRamKeyVer, pUid, bUidLen,
...
phStatus_t phalMfdfEVx_DecryptSDMPICCData(void * pDataParams, uint16_t wKeyNo, uint16_t wKeyVer, uint8_t * pEncdata, uint16_t wEncDataLen,
    uint8_t * pPlainData)
{
    phStatus_t PH_MEMLOC_REM status;
...
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
        case PHAL_MFDFEVX_SAMAV3_NONX_ID:
            status = phalMfdfEVx_Sam_NonX_DecryptSDMPICCData(pDataParams, wKeyNo, wKeyVer, pEncdata, wEncDataLen, pPlainData);
            break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
