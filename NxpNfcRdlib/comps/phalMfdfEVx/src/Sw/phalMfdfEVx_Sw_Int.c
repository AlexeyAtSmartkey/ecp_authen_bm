...
#ifdef NXPBUILD__PHAL_MFDFEVX_NDA
phStatus_t phalMfdfEVx_Sw_Int_ReadData_Enc(phalMfdfEVx_Sw_DataParams_t * UNALIGNED pDataParams, uint8_t bOption, uint8_t * bCmdBuff,
    uint16_t wCmdLen, uint8_t ** ppRxdata, uint16_t * pRxdataLen)
{
...
phStatus_t phalMfdfEVx_Sw_Int_Write_Enc(phalMfdfEVx_Sw_DataParams_t * pDataParams, uint8_t bIns, uint8_t * bCmdBuff,
    ...
    uint16_t wCmdLen, uint8_t * pData, uint16_t wDataLen)
{
    ...
    if (bCommOption == PHAL_MFDFEVX_COMMUNICATION_ENC)
    {
        ...
        {
            /* Set the IV length */
            bIvLen = (uint8_t) ((pDataParams->bAuthMode == PHAL_MFDFEVX_AUTHENTICATEISO) ? PH_CRYPTOSYM_DES_BLOCK_SIZE :
    ...
    if (bCommOption == PHAL_MFDFEVX_COMMUNICATION_ENC)
    {
        ...
        else if (pDataParams->bAuthMode == PHAL_MFDFEVX_AUTHENTICATEEV2)
        {
            ...
            /* Copy the response.  */
            (void)memcpy(&pDataParams->pUnprocByteBuff[pDataParams->bNoUnprocBytes], pResponse, (wRespLen - 8));
...
phStatus_t phalMfdfEVx_Sw_Int_ComputeIv(uint8_t bIsResponse, uint8_t * pTi, uint16_t wCmdCtr, uint8_t * pIv)
{
...
#ifdef NXPBUILD__PHAL_MFDFEVX_NDA
phStatus_t phalMfdfEVx_Sw_Int_DecryptSDMData(phalMfdfEVx_Sw_DataParams_t *pDataParams, uint8_t *pSessEncKey, uint8_t *pIv,
...
phStatus_t phalMfdfEVx_Sw_Int_ComputeSDMSessionVectors(phalMfdfEVx_Sw_DataParams_t * pDataParams, uint8_t bOption,
...
phStatus_t phalMfdfEVx_Sw_Int_GenerateSDMSessionKeysAES(phalMfdfEVx_Sw_DataParams_t *pDataParams, uint8_t bSdmOption,
    uint16_t wKeyNo, uint16_t wKeyVer, uint8_t *pSDMReadCtr, uint8_t * pVCUID, uint8_t bUidLen, uint8_t *pSessEncKey,
    uint8_t *pSessMacKey)
{
    phStatus_t statusTmp = PH_ERR_SUCCESS;
...
phStatus_t phalMfdfEVx_Sw_Int_ComputeSDMIV(phalMfdfEVx_Sw_DataParams_t *pDataParams, uint8_t *pSessEncKey, uint8_t *pSDMReadCtr,
    uint8_t *pIV)
{
    phStatus_t statusTmp = PH_ERR_SUCCESS;
    uint8_t PH_MEMLOC_REM bTmpIV[16] = { '\0' };
