...
#define PHAL_MFDF_CMD_AUTHENTICATE              0x0AU    /**< MF DF Authenticate command. */
#define PHAL_MFDF_CMD_AUTHENTICATE_ISO          0x1AU    /**< MF DF Authenticate ISO command. */
#define PHAL_MFDF_CMD_AUTHENTICATE_AES          0xAAU    /**< MF DF Authenticate AES command. */
#define PHAL_MFDF_CMD_CHANGE_KEY_SETTINGS       0x54U    /**< MF DF Change key settings cmd. */
#define PHAL_MFDF_CMD_GET_KEY_SETTINGS          0x45U    /**< MF DF Get Key Settings Cmd.  */
#define PHAL_MFDF_CMD_CHANGE_KEY                0xC4U    /**< MF DF Change key cmd. */
#define PHAL_MFDF_CMD_GET_KEY_VERSION           0x64U    /**< MF DF Get Key Version. */

#endif /* NXPBUILD__PH_NDA_MFDF */
#define PHAL_MFDF_CMD_CREATE_APPLN              0xCAU    /**< MF DF Create Application cmd. */
#ifdef NXPBUILD__PH_NDA_MFDF

#define PHAL_MFDF_CMD_DELETE_APPLN              0xDAU    /**< MF DF Delete Application cmd. */
#define PHAL_MFDF_CMD_GET_APPLN_IDS             0x6AU    /**< MF DF Get Application Ids cmd. */
#define PHAL_MFDF_CMD_GET_DF_NAMES              0x6DU    /**< MF DF Get Dedicated Fine names cmd. */

#endif /* NXPBUILD__PH_NDA_MFDF */
#define PHAL_MFDF_CMD_SELECT_APPLN              0x5AU    /**< MF DF Select Application Cmd. */
#ifdef NXPBUILD__PH_NDA_MFDF

#define PHAL_MFDF_CMD_FORMAT_PICC               0xFCU    /**< MF DF Format PICC Cmd. */

#endif /* NXPBUILD__PH_NDA_MFDF */
#define PHAL_MFDF_CMD_GET_VERSION               0x60U    /**< MF DF Get Version cmd. */
#ifdef NXPBUILD__PH_NDA_MFDF

#define PHAL_MFDF_CMD_FREE_MEM                  0x6EU    /**< MF DF Free Memory cmd. */
#define PHAL_MFDF_CMD_SET_CONFIG                0x5CU    /**< MF DF Set Configuration Cmd. */
#define PHAL_MFDF_CMD_GET_CARD_UID              0x51U    /**< MF DF Get Card UID cmd. */
#define PHAL_MFDF_CMD_GET_FILE_IDS              0x6FU    /**< MF DF Get File IDs cmd. */
#define PHAL_MFDF_CMD_GET_ISO_FILE_IDS          0x61U    /**< MF DF Get ISO File IDs cmd. */
#define PHAL_MFDF_CMD_GET_FILE_SETTINGS         0xF5U    /**< MF DF Get File settings cmd. */
#define PHAL_MFDF_CMD_CHANGE_FILE_SETTINGS      0x5FU    /**< MF DF Change file settings cmd. */

#endif /* NXPBUILD__PH_NDA_MFDF */
#define PHAL_MFDF_CMD_CREATE_STD_DATAFILE       0xCDU    /**< MF DF Create Standard data file cmd. */
#ifdef NXPBUILD__PH_NDA_MFDF

#define PHAL_MFDF_CMD_CREATE_BKUP_DATAFILE      0xCBU    /**< MF DF Create Backup data file cmd. */
#define PHAL_MFDF_CMD_CREATE_VALUE_FILE         0xCCU    /**< MF DF Create Value File cmd. */
#define PHAL_MFDF_CMD_CREATE_LINEAR_RECFILE     0xC1U    /**< MF DF Create Linear record file cmd. */
#define PHAL_MFDF_CMD_CREATE_CYCLIC_RECFILE     0xC0U    /**< MF DF Create Cyclic record file cmd. */
#define PHAL_MFDF_CMD_DELETE_FILE               0xDFU    /**< MF DF Delete File cmd. */
#define PHAL_MFDF_CMD_READ_DATA                 0xBDU    /**< MF DF Read Data cmd. */

#endif /* NXPBUILD__PH_NDA_MFDF */
#define PHAL_MFDF_CMD_WRITE_DATA                0x3DU    /**< MF DF Write data cmd. */
#ifdef NXPBUILD__PH_NDA_MFDF

#define PHAL_MFDF_CMD_GET_VALUE                 0x6CU    /**< MF DF Get Value cmd. */
#define PHAL_MFDF_CMD_CREDIT                    0x0CU    /**< MF DF Credit cmd. */
#define PHAL_MFDF_CMD_DEBIT                     0xDCU    /**< MF DF Debit cmd. */
#define PHAL_MFDF_CMD_LIMITED_CREDIT            0x1CU    /**< MF DF Limited Credit cmd. */
#define PHAL_MFDF_CMD_WRITE_RECORD              0x3BU    /**< MF DF Write Record cmd. */
#define PHAL_MFDF_CMD_READ_RECORDS              0xBBU    /**< MF DF Read Records cmd. */
#define PHAL_MFDF_CMD_CLEAR_RECORDS_FILE        0xEBU    /**< MF DF Clear records file cmd. */
#define PHAL_MFDF_CMD_COMMIT_TXN                0xC7U    /**< MF DF Commit transaction cmd. */
#define PHAL_MFDF_CMD_ABORT_TXN                 0xA7U    /**< MF DF Abort transaction cmd. */
