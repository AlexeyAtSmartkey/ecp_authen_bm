                                 ...
                                 )
{
    ...
    if (0U != (bDivLen)) PH_ASSERT_NULL(pDivInput);
                              ...
                              )
{
    ...
    */
    ...
    PH_ASSERT_NULL (pDataParams);
    if (bDivLen > 0U)PH_ASSERT_NULL (pDivInput);
                                      ...
                                      )
{
    ...
    */
    ...
    PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pAidBuff_log, pAidBuff, (*pNumAIDs) * 3U);
                                  ...
                                  )
{
    ...
    PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pFidBuffer_log, pFidBuffer, (*pNumFIDs) * 2U);
    ...
    )
{
    ...
    PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
    PH_ASSERT_NULL (pDataParams);
    if (bOption == 1U)PH_ASSERT_NULL (pISOFileId);
    PH_ASSERT_NULL (pAccessRights);
    PH_ASSERT_NULL (pFileSize);
...
phStatus_t phalMfdf_ResetAuthStatus(void * pDataParams)
{
    ...
    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phalMfdf_ResetAuthStatus");
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(status);
    PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
    PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
    PH_ASSERT_NULL (pDataParams);
