...
*******************************************************************************/
    ...
    #define PH_NFCLIB_KEYSTORE_DATAPARAMS_SAM_AV3 (&gphNfcLib_Params.sKeyStore_SamAv3)
 ...
 */
#define NUMBER_OF_KEYENTRIES        8U//6U
...
#define CMD_BUFFER_SIZE 280                     /* CMD Buffer Size */
static uint8_t aCmd_Buffer[CMD_BUFFER_SIZE];    /* Buffer for DESFire commands */
...
#ifdef NXPBUILD__PH_KEYSTORE_SAMAV3
#   define PTR_sKeyStore_SamAv3 (&gphNfcLib_Params.sKeyStore_SamAv3)
#endif /* NXPBUILD__PH_KEYSTORE_SAMAV3 */
...
static phStatus_t phNfcLib_AL_Init(void)
{
    ...
    do
    {
        ...
        PH_CHECK_NFCLIB_INIT_FCT(wStatus, phalMful_SamAV3_NonX_Init(
            &gphNfcLib_Params.salMFUL_SamNonX,
            (uint16_t)(sizeof(phalMful_SamAV3_NonX_DataParams_t)),
            &gphNfcLib_Params.sHal_SamAv3,
            &gphNfcLib_Params.spalMifare));
        ...
        /* Initialize the VCA SAM NON X component */
        PH_CHECK_NFCLIB_INIT_FCT(wStatus, phalVca_SamAV3_NonX_Init(
            &sVca_SamNonX,
            sizeof(phalVca_SamAV3_NonX_DataParams_t),
            &gphNfcLib_Params.sHal_SamAv3,
            &gphNfcLib_Params.spalMifare));
    #endif /* NXPBUILD__PHAL_VCA_SAMAV3_NONX */
    #endif /* NXPBUILD__PHAL_VCA_SAM_NONX */

        /* Initialize AL MIFARE DESFire EVx SAM NON X component */
        PH_CHECK_NFCLIB_INIT_FCT(wStatus, phalMfdfEVx_SamAV3_NonX_Init(
            &gphNfcLib_Params.salMFDFEVx_SamNonX,
            sizeof(phalMfdfEVx_SamAV3_NonX_DataParams_t),
            &gphNfcLib_Params.sHal_SamAv3,
            &gphNfcLib_Params.spalMifare,
            &sTMI,
            aCmd_Buffer,
        ...
        PH_CHECK_NFCLIB_INIT_FCT(wStatus, phalMfpEVx_SamAV3_NonX_Init (
            &gphNfcLib_Params.salMFPEVx_SamNonX,
            sizeof(phalMfpEVx_SamAV3_NonX_DataParams_t),
            &gphNfcLib_Params.sHal_SamAv3,
            &gphNfcLib_Params.spalMifare,
            &sTMI));
        ...
        PH_CHECK_NFCLIB_INIT_FCT(wStatus, phalICode_SamAV3_NonX_Init(
            &gphNfcLib_Params.salICode_SamNonX,
            (uint16_t)(sizeof(phalICode_SamAV3_NonX_DataParams_t)),
            &gphNfcLib_Params.sHal_SamAv3,
            &gphNfcLib_Params.spalSli15693,
            PTR_sCryptoSym,
            PTR_sCryptoRng,
...
phNfcLib_Status_t phNfcLib_Init(void)
{
    ...
    if (((phNfcLib_StateMachine_t)gphNfcLib_State.bNfcLibState) == eNfcLib_ResetState)
    {
        do
        {
            ...
            /* Initialize the SAM AV3 HAL component */
            PH_CHECK_SUCCESS_FCT(wStatus, phhalHw_SamAV3_Init(
                ...
                0x00,
                gphNfcLib_State.bSamAv3HalBufferTx,
                PH_NXPNFCRDLIB_CONFIG_SAM_AV3_HAL_TX_BUFFSIZE,
                gphNfcLib_State.bSamAv3HalBufferRx,
                PH_NXPNFCRDLIB_CONFIG_SAM_AV3_HAL_RX_BUFFSIZE,
                NULL));
#endif /* NXPBUILD__PHHAL_HW_SAMAV3 */

#ifdef NXPBUILD__PH_KEYSTORE_SAMAV3
            PH_CHECK_SUCCESS_FCT(wStatus, phKeyStore_SamAV3_Init(
                PTR_sKeyStore_SamAv3,
                (uint16_t)(sizeof(phKeyStore_SamAV3_DataParams_t)),
                &gphNfcLib_Params.sHal_SamAv3));
#endif /* NXPBUILD__PH_KEYSTORE_SAMAV3 */
                             ...
                             )
{
    ...
    if (((phNfcLib_StateMachine_t)gphNfcLib_State.bNfcLibState) != eNfcLib_ResetState)
    {
        ...
        if ((wComponent & PH_COMP_MASK) == PH_COMP_HAL)
        {
            switch(bComponentType)
            {
#ifdef NXPBUILD__PHHAL_HW_SAMAV3
            case PH_NFCLIB_COMP_PHHAL_HW_SAMAV3:
                pDataparam = (void *) &gphNfcLib_Params.sHal_SamAv3;
                break;
#endif /* NXPBUILD__PHHAL_HW_SAMAV3 */
            default:
                /* Do nothing. pDataparam is already null. */
        ...
        if ((wComponent & PH_COMP_MASK) == PH_COMP_KEYSTORE)
        {
            switch(bComponentType)
            {
#ifdef NXPBUILD__PH_KEYSTORE_SAMAV3
            case PH_NFCLIB_COMP_KEYSTORE_SAMAV3:
                pDataparam = (void *) &gphNfcLib_Params.sKeyStore_SamAv3;
                break;
#endif /* NXPBUILD__PH_KEYSTORE_SAMAV3 */
            default:
                /* Do nothing. pDataparam is already null. */
        ...
        if ((wComponent & PH_COMP_MASK) == PH_COMP_AL_ICODE)
        {
            switch(bComponentType)
            {
#ifdef NXPBUILD__PHAL_ICODE_SAM_NONX
            case PH_NFCLIB_COMP_ICODE_SAM_NONX:
                pDataparam = (void *) &gphNfcLib_Params.salICode_SamNonX;
                break;
#endif /* NXPBUILD__PHAL_ICODE_SAM_NONX */
            default:
                /* Do nothing. pDataparam is already null. */
        ...
        if ((wComponent & PH_COMP_MASK) == PH_COMP_AL_MFDFEVX)
        {
            switch(bComponentType)
            {
#ifdef NXPBUILD__PHAL_MFDFEVX_SAM_NONX
            case PH_NFCLIB_COMP_MFDFEVX_SAM_NONX:
                pDataparam = (void *) &gphNfcLib_Params.salMFDFEVx_SamNonX;
                break;
#endif /* NXPBUILD__PHAL_MFDFEVX_SAM_NONX */
            default:
                /* Do nothing. pDataparam is already null. */
        ...
        if ((wComponent & PH_COMP_MASK) == PH_COMP_AL_MFPEVX)
        {
            switch(bComponentType)
            {
#ifdef NXPBUILD__PHAL_MFPEVX_SAM_NONX
            case PH_NFCLIB_COMP_MFPEVX_SAM_NONX:
                pDataparam = (void *) &gphNfcLib_Params.salMFPEVx_SamNonX;
                break;
#endif /* NXPBUILD__PHAL_MFPEVX_SAM_NONX */
            default:
                /* Do nothing. pDataparam is already null. */
        ...
        if ((wComponent & PH_COMP_MASK) == PH_COMP_AL_MFUL)
        {
            switch(bComponentType)
            {
#ifdef NXPBUILD__PHAL_MFUL_SAM_NONX
            case PH_NFCLIB_COMP_MFUL_SAM_NONX:
                pDataparam = (void *) &gphNfcLib_Params.salMFUL_SamNonX;
                break;
#endif /* NXPBUILD__PHAL_MFUL_SAM_NONX */
            default:
                /* Do nothing. pDataparam is already null. */
