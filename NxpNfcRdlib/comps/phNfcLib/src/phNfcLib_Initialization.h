...
typedef struct
{
    ...
    phhalHw_SamAV3_DataParams_t        sHal_SamAv3;        /**< SAM AV3 HAL component holder */
    ...
    phKeyStore_SamAV3_DataParams_t     sKeyStore_SamAv3;   /**< SAM AV3 Keystore component holder */
    ...
    phalICode_SamAV3_NonX_DataParams_t salICode_SamNonX;   /* ICode AL SAM NON X component */
    ...
    phalMfdfEVx_SamAV3_NonX_DataParams_t salMFDFEVx_SamNonX; /* AL MIFARE DESFire Ev2 SAM NON X component */
    ...
    phalMfpEVx_SamAV3_NonX_DataParams_t salMFPEVx_SamNonX; /* AL MIFARE Plus Ev2 SAM NON X component */
    ...
    phalMful_SamAV3_NonX_DataParams_t  salMFUL_SamNonX;    /* AL MIFARE Ultralight SAM NON X contactless IC component */
...
typedef struct
{
    ...
    uint8_t  bVASPolling;                                          /* Either VAS Polling is #PH_ON or #PH_OFF */
...
#ifdef NXPBUILD__PHHAL_HW_SAMAV3
    uint8_t  bSamAv3HalBufferTx[PH_NXPNFCRDLIB_CONFIG_SAM_AV3_HAL_TX_BUFFSIZE];  /* SAM AV3 HAL TX buffer. */
    uint8_t  bSamAv3HalBufferRx[PH_NXPNFCRDLIB_CONFIG_SAM_AV3_HAL_TX_BUFFSIZE];  /* SAM AV3 HAL RX buffer. */
#endif /* NXPBUILD__PHHAL_HW_SAMAV3 */
